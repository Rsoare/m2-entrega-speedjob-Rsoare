const frontEndJobs = [
    ...
    },
    {
        id:03,
        title: "Desenvolvedor Frontend",
        description:"The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other greater pleasures,",
        modality: ["Full Time","Presencial"]
    },
    {
        id:04,
        title: "Programador Frontend",
        description:"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms",
        modality: ["Full Time","Remote"]
    },
    {
        id:05,
        title: "UI Developer",
        description:"But in certain circumstances and owing to the claims of duty or the obligations",
        modality: ["Full Time","Remote"]
    },
    {
        id:06,
